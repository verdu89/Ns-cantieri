...
export default function UserMenu({ dropUp = false }: UserMenuProps) {
  ...
  const itemCls = `
    flex items-center gap-2 px-3 py-2 rounded text-sm w-full text-left transition
    ${
      theme === "light"
  ...
  return (
    <div className="relative w-full" ref={ref}>
      ...
      <button
        ...
        className="flex items-center gap-2 px-2 py-1 rounded w-full transition hover:bg-orange-50 dark:hover:bg-gray-700"
      >
        <div
      ...
      {openDesktop && (
        ...
        >
          <div className="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
            ...
            <div
              className={`text-[11px] mt-1 inline-block px-2 py-0.5 rounded-full border
                ${
                  theme === "light"
